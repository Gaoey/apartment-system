      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {apartments.length === 0 ? (
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No apartments yet</h3>
            <p className="text-gray-600 mb-4">Get started by creating your first apartment building</p>
            <Link
              href="/apartments/new"
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="space-y-1 text-gray-600">
                      ...
                      <p><span className="font-medium">Phone:</span> {apartment.phone}</p>
                      <p><span className="font-medium">Tax ID:</span> {apartment.taxId}</p>
                      <p><span className="font-medium">Created:</span> {new Date(apartment.createdAt).toLocaleDateString()}</p>
                    </div>
                  </div>
                  <div className="flex gap-2 ml-4">
                    <Link
                      href={`/apartments/${apartment._id}/rooms`}
